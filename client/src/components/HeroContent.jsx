...
// Everything in the hero that depends on the visitor's screen size (the
// RAP/DS composite, paddings, the live river-status pill) — split out of
// Hero.jsx into its own lazy chunk. Hero.jsx is part of the prerendered,
// hydrated homepage shell and paints the background + <h1> from HTML; this
// component (and framer-motion with it) only loads after hydration, so
// neither sits in front of the first paint on slow phones.
...
const HeroContent = ({ shouldLoadBackground }) => {
