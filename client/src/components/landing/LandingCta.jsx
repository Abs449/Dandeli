...
const LandingCta = ({ heading, subheading }) => (
  <section className="py-16 sm:py-20 bg-[#021915] border-t border-white/10 text-center px-4">
    ...
    <Link
      to="/booking"
      className="inline-block px-10 py-4 rounded-full font-heading font-black text-xs sm:text-sm uppercase tracking-wider text-[#021915] shadow-xl hover:brightness-110 transition-all duration-200 hover:-translate-y-0.5"
