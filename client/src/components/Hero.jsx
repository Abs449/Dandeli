...
const Hero = () => {
  return (
    <div className="relative h-[90vh] flex items-center justify-center bg-gray-900 overflow-hidden">
      ...
      <div
        className="absolute inset-0 z- bg-cover bg-center transition-transform duration-[20s] hover:scale-105"
        style={{
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 w-full max-w-5xl mx-auto">
        ...
        >
          ...
          >
            Welcome to <span className="text-accent">Dandeli Kali River Rafting</span>
          </motion.h1>
          ...
          >
            loacted near GaneshGudi Temple, Sunkosali, Dandeli.
          </motion.p>
