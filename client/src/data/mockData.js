export const services = [
  {
    id: 1,
    name: 'River Rafting',
    shortDescription: 'Experience the thrill of white water rafting on the Kali River.',
    fullDescription: 'Our river rafting experience on the Kali River is perfect for adrenaline junkies. Navigate through exciting rapids surrounded by lush green forests. Suitable for both beginners and experienced rafters.',
  ...
  },
  {
    id: 2,
    name: 'Kayaking',
    shortDescription: 'Paddle through calm waters and enjoy the serene environment.',
    fullDescription: 'Kayaking in Dandeli is a peaceful yet exciting activity. Paddle along the quiet stretches of the Kali River, spotting local birds and enjoying the pristine natural beauty of the Western Ghats.',
  ...
  },
  {
    ...
    fullDescription: 'Disconnect from the world and connect with nature. Our camping sites are located in safe, scenic spots within the forest. Enjoy a bonfire, barbecue, and the soothing sounds of the jungle at night.',
    image: 'https://images.unsplash.com/photo-1504280390467-3174246194b1?auto=format&fit=crop&q=80&w=800',
  ...
  },
  {
    ...
    fullDescription: 'Get a bird\'s eye view of the Kali River and surrounding forests as you zoom across our secure zipline. A short but unforgettable burst of excitement for adventure lovers.',
    image: 'https://images.unsplash.com/photo-1596489813295-654dbdae3e53?auto=format&fit=crop&q=80&w=800',
    duration: '15 Minutes',
    difficulty: 'Easy',
  ...
  },
  {
    ...
    fullDescription: 'Embark on a guided jeep safari deep into the Dandeli Wildlife Sanctuary. Keep your eyes peeled for black panthers, elephants, and a diverse range of exotic birds.',
  ...
  },
  {
    ...
    fullDescription: 'Join our expert guides for a trek through the thick jungles of Dandeli. Discover hidden waterfalls, unique flora, and challenge yourself physically while breathing the freshest air.',
  ...
  },
  {
    ...
    fullDescription: 'Dandeli is a paradise for bird lovers. Accompanied by our naturalist, you will be able to spot Hornbills, Kingfishers, and many more rare species early in the morning.',
    image: 'https://images.unsplash.com/photo-1555169062-013468b47731?auto=format&fit=crop&q=80&w=800',
    duration: '2 Hours',
    difficulty: 'Easy',
...
export const packages = [
  ...
  },
  {
    ...
    activities: ['Resort Stay', 'All Water Sports', 'Jungle Safari', 'All Meals'],
    recommended: false
  }
];
